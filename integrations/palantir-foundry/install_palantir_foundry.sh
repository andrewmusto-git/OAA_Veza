...
# Test the connection
print_info "Testing connection to Palantir Foundry..."
if python3 palantir_foundry.py --test; then
...
echo "- Logs: $INTEGRATION_PATH/palantir_foundry_veza_integration.log"
